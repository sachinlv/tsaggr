...
filepath <<- '/home/freak/Programming/Thesis/results/results/neuralnet_shortterm_aggr/'
...
file.name.aggr.denorm.generic <<- 'neuralnet_shortterm_aggr_combi_aggr_denorm'
