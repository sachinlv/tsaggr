...
filepath.generic <<- '/home/freak/Programming/Thesis/results/results/brnn_shortterm_solar_'
file.name.generic <<- 'brnn_shortterm_solar_aggr_combi'
file.name.denorm.generic <<- 'brnn_shortterm_solar_aggr_combi_denorm'
file.name.aggr.generic <<- 'brnn_shortterm_solar_aggr_combi_aggr'
file.name.aggr.denorm.generic <<- 'brnn_shortterm_solar_aggr_combi_aggr_denorm'
