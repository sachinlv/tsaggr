...
filepath.generic <<- '/home/freak/Programming/Thesis/results/results/mars_shortterm_solar_'
file.name.generic <<- 'mars_shortterm_solar_aggr_combi'
file.name.denorm.generic <<- 'mars_shortterm_solar_aggr_combi_denorm'
file.name.aggr.generic <<- 'mars_shortterm_solar_aggr_combi_aggr'
file.name.aggr.denorm.generic <<- 'mars_shortterm_solar_aggr_combi_aggr_denorm'
