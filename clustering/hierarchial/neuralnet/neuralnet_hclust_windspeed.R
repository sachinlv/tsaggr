...
plot.file.generic <- 'neuralnet_shortterm_windspeed_hclust_'
plot.file.path <- '/home/freak/Programming/Thesis/plots/wind/clustering/physical/history10/random_sites/neuralnet/'
file.name.generic <<-'neuralnet_shortterm_hclust'
forecast.aggr.err.file <<- 'neuralnet_shortterm_hclust_aggr.csv'
filepath.generic <<- '/home/freak/Programming/Thesis/results/clustering/history10/random_sites/neuralnet_shortterm_windspeed_hclust/'
